...
NSmorrismap <- ggplot() + 
  ...
  #annotate(geom="rect", xmin=-67, xmax=-66.25, ymin=43.4, ymax= 44, fill="grey") +
  #annotate(geom="rect", xmin=-64, xmax=-59.5, ymin=43.4, ymax= 44, fill="grey") +
...
NLmorrismap <- ggplot() + 
  #ggtitle("Maritimes salmon rivers")+
  geom_path(data=CA.NL, aes(long, lat, group=group), colour="black") +
