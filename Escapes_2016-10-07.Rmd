...
sPath <- shortestPath(tr3c, cbind(sitedist.join[,2], sitedist.join[,1]), cbind(sitedist.join[,6], sitedist.join[,5]), output="SpatialLines")
...
plot(NLrast, xlim=c(-55.5, -55.25), ylim=c(47.6, 47.8))
lines(sPath)
