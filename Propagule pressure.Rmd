...
prop.press <- apply(as.matrix(dist2AQ[,20:31]), 2, function(x) sum(x, na.rm=TRUE))
...
plot2 <- ggplot() + 
  ...
  scale_size_continuous(name="Propagule\npressure=\n\u03A3(total fish/dist)", range = c(0.5,10), limits=c(100,9000), breaks=c(500, 1000, 2500, 5000, 7500, 9000))
