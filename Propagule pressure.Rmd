...
prop.press_all <- join(prop.press_all, qvals, type="left")
prop.press_all
ggplot() + geom_point(data=prop.press_all, aes(prop.press, q)) +
  geom_label_repel(data=prop.press_all, aes(prop.press, q, label=code)) +
  xlim(500,1500) +
  theme_classic() + 
...
prop.press2013 <- join(prop.press2013, qvals, type="left")
ggplot() + geom_point(data=prop.press2013, aes(prop.press, q)) +
  geom_label_repel(data=prop.press2013, aes(prop.press, q, label=code)) +
  xlim(0,300) +
  theme_classic() + 
  theme(panel.background=element_rect(colour="black")) +
  ggtitle("2013")+
