...
badsites3[badsites3$prov=="NB",5:4] <- c(-66.72366, -66.81626,
                                         -66.84110, -66.87046,
                                         -66.93822, -66.94725,
                                         -66.94725, -67.02178,
                                         -66.97210, -66.70334,
...
badsites3[badsites3$prov=="NS" & !badsites3$Site.ID==193,5:4] <- rbind(c(-64.31949, 44.40483), 
                                                                       c(-66.33586, 44.26520), 
                                                                       c(-65.74907, 44.64712), 
                                                                       c(-65.70305, 44.65533))
...
badsites3[badsites3$prov=="NS" & badsites3$Site.ID==193,5:4] <- c(-60.97574, 46.01276)
...
badsites3[badsites3$prov=="NL", 5:4] <- rbind(c(-55.36079, 47.70331),
                                              c(-55.61069, 47.53106),
                                              c(-55.83952, 47.79449),
                                              c(-55.85006, 47.81273),
                                              c(-55.88469, 47.62326),
...
write.csv(reportlocs[2:5], "C:/Users/keyserf/Documents/Data/R output/reportlocs.csv")
...
## for all reports
calcAQpress(AQsites = sitecoords_atl[is.na(sitecoords_atl$Long)=="FALSE",], inventory = inventory1[is.na(inventory1$Long)=="FALSE",], rivercoords = reportlocs, dir="C:/Users/keyserf/Documents/Data/R output", saveRast=FALSE)
