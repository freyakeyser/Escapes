...
reportlocs <- unique(fullreports[,c(1:2,17:18)])
reportlocs[reportlocs$River=="Magaguadavic",2:3] <- c(45.122017, -66.910076)
reportlocs[reportlocs$River=="Conne River",2:3] <- c(45.867332, -55.801525)
...
eastus <- getData("GADM", country="USA", level=2)
eastus <- crop(eastus, extent(-71, -67, 42, 49))
...
reportlocs[reportlocs$River=="Dennis Stream", 3:2] <- c(-67.19659, 45.1643)
...
reportlocs[reportlocs$River=="Lahave", 3:2] <- c(-64.34176, 44.28187)
reportlocs[reportlocs$River=="Little River", 3:2] <- c(-55.81197, 47.7953)
...
reportlocs[reportlocs$River=="Bay Du Nord", 3:2] <- c(-55.4175, 47.71868)
reportlocs[reportlocs$River=="Tailrace", 3:2] <- c(-55.76375, 47.93676)
reportlocs[reportlocs$River=="Shoal Brook", 3:2] <- c(-55.68705, 47.66858)
...
detections <- ddply(.data=fullreports, .(River),
                    summarize,
                    detect = max(detected))
...
head(prop.press_avg_reports)


plotavg <- join(prop.press_avg_reports, fullreports, type="left")
ggplot() + geom_point(data=prop.press_avg_reports, aes(averagepress, detect2)) + theme_classic() +
