...
reports <- read.csv("C:/Users/keyserf/Documents/Data/Escape events and reports/Escapee reports_2017-02-24.csv")
...
# 494 different river/year reports
```
...
reportlocs[reportlocs$River=="Garnish River", 3:2] <- c(-55.3614, 47.23877)
...
reportlocs[reportlocs$River=="North West Brook 1", 3] <- -55.39005
reportlocs[reportlocs$River=="North West Brook 1", 2] <- 47.72007
...
reportlocs[reportlocs$River=="Salmon River 2", 3:2] <- c(-56.09316, 47.74895)
...
reportlocs[reportlocs$River=="Simmons Brook", 3:2] <-c(-55.45720, 47.63639)
...
sitecoords_atl_2[sitecoords_atl_2$Site.ID==2012,3:2] <- c(-55.82891, 47.54275) #ID2012
sitecoords_atl_2[sitecoords_atl_2$Site.ID==1082,3:2] <- c(-55.33238, 47.65957) #ID1082
...
avgpp <- read.csv("C:/Users/keyserf/Documents/Data/R output/prop.press_avg_2017-02-10.csv")
allpp <- read.csv("C:/Users/keyserf/Documents/Data/R output/prop.press_final_2017-02-10.csv")
