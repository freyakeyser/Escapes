...
datl_full <- costDistance(tratlc, fromCoords = cbind(as.numeric(sitecoords_atl$Long), as.numeric(sitecoords_atl$Lat)), toCoords = cbind(as.numeric(reportlocs$longfinal), as.numeric(reportlocs$latfinal)))
